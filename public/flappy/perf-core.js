...
(function () {
  ...
  /* ══ GAME-SPECIFIC GLUE (Flappy Bounce / raw canvas) ═════════════════ */

  // Gameplay-active gate: assets/script.js sets window.__perfActive from its
  // IIFE-scoped gameState ('playing' only).

  // Immediate scale apply: resizeCanvas() (IIFE-scoped) re-derives the canvas
  // backing store from the PERF-patched lines; trigger it via a resize event.
